...
generate() {
  ...
  SHADER="${BUILD_DIR}/kwin4_effect_$1/contents/shaders/$1.frag"
  echo "#version 140"                                                      >  "$SHADER"
  echo "#define KWIN"                                                      >> "$SHADER"
  echo ""                                                                  >> "$SHADER"
  echo "// This file is automatically generated during the build process." >> "$SHADER"
  echo ""                                                                  >> "$SHADER"
  cat "../resources/shaders/common.glsl"                                   >> "$SHADER"
  cat "../resources/shaders/$1.frag"                                       >> "$SHADER"
}
