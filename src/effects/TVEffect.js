...
export default class Effect {
  ...
  static description = "The TV Effect fades the window out by first making it transparent from the top and bottom edges towards the center, then collapsing the remaining line from the sides to the middle, mimicking an old television shutdown effect with a customizable color.";
