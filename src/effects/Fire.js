...
export default class Effect {
  ...
  static description = "The Fire effect adds a dynamic fire-like animation to the window, using a vertical noise shader to simulate flames with customizable color gradients and movement speed. This effect pays homage to the classic Compiz fire effect, with a modern implementation through shader techniques.";
