...
export default class Effect {
  ...
  static description = "The Pixel Wipe effect pixelates the window and gradually hides pixels in a radial pattern starting from the mouse pointer position, offering a unique transition with a customizable pixel size.";
