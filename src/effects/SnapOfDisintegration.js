...
export default class Effect {
  ...
  static description = "The Snap of Disintegration effect dissolves the window into a cloud of dust particles, simulating a gradual disintegration. Using a layered dust texture, this effect creates the appearance of the window breaking apart into floating particles with customizable color and scale.";
