...
export default class Effect {
  ...
  static description = "The Matrix effect overlays a cascading grid of random letters, mimicking the iconic 'Matrix' code with customizable trail and tip colors, randomness, and letter size. The letters flow downward at variable speeds, creating a dynamic, glitchy animation reminiscent of digital rain.";
