...
export default class Effect {
  ...
  static description = "The T-Rex Attack effect simulates a window being violently torn apart by claw scratches. With customizable claw size, color, and warp intensity, this effect creates a dramatic and ferocious attack animation, as if a T-Rex has ripped through the screen.";
