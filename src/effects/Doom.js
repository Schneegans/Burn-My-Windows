...
export default class Effect {
  ...
  static description = "The Doom effect melts the window, creating a vertical, pixelated distortion inspired by the classic screen transitions of the original Doom game. The effect stretches and scales the window, giving it a liquefied appearance as it dissolves downward.";
